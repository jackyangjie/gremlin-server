...
import static com.trs.graph.TrsGraphManager.TRS_GRAPH_MANAGER_EXPECTED_STATE_MSG;
 ...
 * @author yangjie
 * @Description
 * @DATE 2020.11.10 12:03
 **/
public class TrsGraphFactory {

    private static final Logger log =
            LoggerFactory.getLogger(TrsGraphFactory.class);
    /**
    ...
    public static JanusGraph open(ReadConfiguration configuration, String backupName) {
        ...
        final TrsGraphManager jgm = TrsGraphManager.getInstance();
        if (null != graphName) {
            Preconditions.checkNotNull(jgm, TRS_GRAPH_MANAGER_EXPECTED_STATE_MSG);
    ...
    /**
     * Returns a {@link TrsGraphFactory.Builder} that allows to set the configuration options for opening a JanusGraph graph database.
     * <p>
     ...
     * @return
     */
    public static TrsGraphFactory.Builder build() {
        return new TrsGraphFactory.Builder();
    }
    ...
    public static class Builder {
         ...
         * @return
         */
        public TrsGraphFactory.Builder set(String path, Object value) {
        ...
        public JanusGraph open() {
            ...
            return TrsGraphFactory.open(mc);
        }
